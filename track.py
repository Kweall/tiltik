                    ...
                    for j, (output) in enumerate(outputs[i]):
                        ...
                        if save_txt:
                            ...
                            with open(txt_path + '.txt', 'a') as f:
                                ...
                                cursor.execute(f'INSERT INTO shema.table ("frame", "id", "bbox_left", "bbox_top", "bbox_w", "bbox_h") VALUES (%s, %s, %s, %s, %s, %s);',
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='C:/Users/Алексей/PycharmProjects/tilt/static/uploads/video.mp4', help='source')  # file/folder, 0 for webcam
